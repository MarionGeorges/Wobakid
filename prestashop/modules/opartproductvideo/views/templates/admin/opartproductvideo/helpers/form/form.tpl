...
{block name="other_input"}
	...
	<h3>{l s='Products:' mod='opartProductVideo'}</h3>
		...
		<tr>
			...
			<td style=" vertical-align:top">
				...
				<a href="#" id="move_to_left" class="multiple_select_remove">
					&lt;&lt; {l s='Remove' mod='opartProductVideo'}
				</a>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<div class="hint" style="display:block">{l s='Double click to move the item to another column' mod='opartProductVideo'}<span class="hint-pointer">&nbsp;</span></div>
			</td>
		</tr>
	</table>
	</div>
	...
	$('#opartproductvideo_form').submit(function()
	{
